                ...
                <form action="xml.php" name="firma" method="post">
                    ...
                    <table>
                        <tr>
                            <td ><br /> <br /> 
                                <b>
                                    Wir bedanken uns für Ihre Anmeldung und wünschen Ihnen weiterhin viel Erfolg!<br />
                                                Sie haben die folgende User ID eingetragen: <?php echo $_smarty_tpl->tpl_vars['userid']->value;?>
 
                                                Dies haben sie über die IP-Adresse <?php echo $_smarty_tpl->tpl_vars['IP']->value;?>
 eingetragen!<br/>
                                                Drücken Sie weiter um ihre xml Datei zu sehen.
                                </b>
                            </td>
                        </tr>
                    </table>
