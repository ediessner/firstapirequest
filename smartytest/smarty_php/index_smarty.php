...
$smarty->assign("main_content1_heading", "Microsoft Word als HTML-Editor?"); /// content 1 Überschrift
$smarty->assign("main_content1_text", "Wir haben den Test gemacht und eine simple, leere Seite, die außer dem Grundgerüst einer Webseite nichts enthält, von Hand erstellt und diese dann mit dem Word-Ergebnis verglichen. Um den Test abzurunden haben wir auch noch die anderen Office-Produkte einbezogen.<br/><br/>

Bevor Sie den Test lesen: Wir haben uns darin nur auf das Office-Paket von Microsoft konzentriert. Dieser kleine Versuch soll nicht die Frage klären, die seit Web-Urzeiten die Entwicklergemeinde teilt: Was ist besser: Von Hand, mit MS Frontpage oder mit Macromedias Dreamweaver? , <br/><br/>sondern nur auf die Möglichkeiten des weit verbreiteten Office eingehen."); /// der content 1 text
