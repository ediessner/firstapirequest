...
$smarty->assign("main_content1_heading", "Samsung bringt verbessertes Galaxy S2"); /// content 1 �berschrift
$smarty->assign("main_content1_text", "Samsung hat eine verbesserte Version des Android-Smartphones Galaxy S2 vorgestellt. Das neue Galaxy S2 LTE hat neben LTE-Technik ein gr��eres Display, einen schnelleren Prozessor und einen NFC-Chip."); /// der content 1 text
...
$smarty->assign("userid", "*"); /// Eingabe der User ID
$smarty->assign("api", "*"); /// Eingabe der API
?>