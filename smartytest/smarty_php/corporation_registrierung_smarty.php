...
$smarty->assign("seiten_titel", "Corporation Registrierung");
...
$smarty->assign("right_tbox1_1_link", "http://www.blick.ch/news/rebellen-haben-die-libysche-hauptstadt-tripolis-eingenommen-vid23557"); 
$smarty->assign("right_tbox1_1_linktext", "Mehr Info`s"); /////link,text
...
//////////////////////////////////////////////Formular Corporation Registrieren---Verteilung der Sterne///////////////////////////////////////////////////////////

$smarty->assign("starfirmenname","*");
$smarty->assign("starstrasse","*");
$smarty->assign("starplz","*");
$smarty->assign("starort","*");
$smarty->assign("startelefon","*");
$smarty->assign("startelefax","");
$smarty->assign("staremail","");
$smarty->assign("starinternet","");
$smarty->assign("starproduktportfolio","*");
$smarty->assign("starfirmenausrichtung","*");
$smarty->assign("stardienstleistungen","*");
$smarty->assign("starpraesenz","");
$smarty->assign("starzielmaerkte","*");
$smarty->assign("starreferenzen","");
$smarty->assign("starunternehmensundfertigungsstandorte","*");
$smarty->assign("starqualitaetsmanagement","");
$smarty->assign("stargruendungsjahr","*");
$smarty->assign("starmitarbeiter","*");
